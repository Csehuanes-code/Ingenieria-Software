...
- **Paquete**: Entidad que se clasifica. Debe tener UUID, coordenadas GPS y datos físicos completos (peso_kg, volumen_m3, tipo_mercancia, metodo_pago, valor_declarado) para poder ser procesada y para que el payload de [Solicitar Ruta de Paquete(MOD1-UC-003)](./MOD1-UC-003-Solicitar-Ruta-De-Paquete.md) sea válido.
